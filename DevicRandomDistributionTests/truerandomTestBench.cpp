...
int main(int argc, char* argv[])
{
	...
	cout << "Alexandar Devic - True Random Memory Generator" << endl;
	...
	std::mt19937 generator(rd());    // random-number engine used (Mersenne-Twister)

	cout << "Generating True Random Distriburion...\n";
	std::uniform_int_distribution<int> distribution(0, pow(2, VIRT_ADDRESS_SPACE));
