// Devic's Chi Square Distribution Generator
//
...
int main(int argc, char* argv[])
{
	...
	cout << "Alexandar Devic - Chi Square Distribution Memory Generator" << endl;
	...
	cout << "Generating Chi Square Distriburion...\n";
	std::chi_squared_distribution<double> distribution(averageVirtLoc);
