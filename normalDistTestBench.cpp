// Devic's Normal Distribution Generator
//
...
int main(int argc, char* argv[])
{
	...
	cout << "Alexandar Devic - Normal Distribution Memory Generator" << endl;
	...
	cout << "Generating Normal Distriburion...\n";
	std::normal_distribution<double> distribution(averageVirtLoc, stDeviation);
